    ...
    <div style="">
        ...
        <table border="0" style="border: 0; text-align:center">
            <tr style="border: 0; text-align:center">
                ...
                <th rowspan="3" width="10%" style="border: 0"><img src="{{ url($student->passport) }}" width="80" height="100" alt=""></th>
            </tr>
            <tr style="border: 0; text-align:center">
  ...
  <main style="margin-top: 40px;">
    ...
    <table style="margin-top: 40px;" cellpadding="5">
        <thead style="text-align: center">
            ...
            <tr>
                <th style="background-color: rgb(235, 129, 8); color: white;">1ST CA</th>
                <th style="background-color: rgb(235, 129, 8); color: white;">2ND CA</th>
                <th style="background-color: rgb(235, 129, 8); color: white;"></th>
            </tr>
        </thead>
        <tbody>
