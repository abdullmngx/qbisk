...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('logo.png') }}" type="image/x-icon" sizes="48x48">
    <link rel="shortcut icon" href="{{ asset('logo.png') }}" type="image/x-icon" sizes="48x48">
    ...
    <div class="page-wrapper" id="pageWrapper">
          ...
          <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><a href="/applicationportal/logout"><i data-feather="log-out"></i>Log out</a></button>
              </li>
            </ul>
          </div>
      ...
      <div class="page-body-wrapper horizontal-menu">
        ...
        <header class="main-nav">
          <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ auth('applicant')->user()->passport ?? '/avatar.png' }}" alt="">
            <div class="badge-bottom"></div><a href="#">
              <h6 class="mt-3 f-14 f-w-600">Applicant</h6></a>
            <p class="mb-0 font-roboto">{{ auth('applicant')->user()->full_name }}</p>
          </div>
          <nav>
            <div class="main-navbar">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="mainnav">
                @include('partials.asidemenus')
              </div>
