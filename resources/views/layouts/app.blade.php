    ...
    <div class="page-wrapper" id="pageWrapper">
      ...
      <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="/staff/dashboard"><img class="img-fluid" width="40" src="/logo.png" alt=""> {{ $config['school_acronym'] }}</a></div>
            <div class="dark-logo-wrapper"><a href="/staff/dashboard"><img class="img-fluid" width="40" src="/logo.png" alt=""> {{ $config['school_acronym'] }}</a></div>
      ...
      <div class="page-body-wrapper horizontal-menu">
        ...
        <header class="main-nav">
          <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ auth('staff')->user()->passport ?? '/avatar.png' }}" alt="">
