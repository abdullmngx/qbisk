      ...
      <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="/staff/dashboard"><img class="img-fluid" width="40" src="/logo.png" alt=""> {{ config('app.name') }}</a></div>
            <div class="dark-logo-wrapper"><a href="/staff/dashboard"><img class="img-fluid" width="40" src="/logo.png" alt=""> {{ config('app.name') }}</a></div>
