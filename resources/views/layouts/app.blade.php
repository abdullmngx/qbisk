    ...
    <div class="page-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper horizontal-menu">
        ...
        <header class="main-nav">
          <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{ asset((auth('staff')->user()->passport ?? '/avatar.png')) }}" alt="">
