                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="disability" id="disability" class="form-control form-select">
                                                    ...
                                                    @foreach ($disabilities as $disability)
                                                        <option value="{{ $disability }}" {{ $student->disability == $disability ? 'selected': '' }}>{{ ucfirst($disability) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-4">
                                                <label for="height">Height (in metres)</label>
                                                <input type="text" name="height" id="height" class="form-control" value="{{ $student->height }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="allergies" id="allergies" class="form-control" value="{{ $student->allergies }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <select name="blood_group" id="blood_group" class="form-control form-select">
                                                    ...
                                                    @foreach ($blood_groups as $blood_group)
                                                        <option value="{{ $blood_group }}" {{ $student->blood_group == $blood_group ? 'selected' : ''}}>{{ $blood_group }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="genotype" id="genotype" class="form-control form-select">
                                                    ...
                                                    @foreach ($genotypes as $genotype)
                                                        <option value="{{ $genotype }}" {{ $student->genotype == $genotype ? 'selected':'' }}>{{ $genotype }}</option>
                                                    @endforeach
                                                </select>
