                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="form_joined" id="form_joined" class="form-control form-select">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="section_id" id="section_id" class="form-control form-select opt">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="arm_id" id="arm" class="form-control form-select">
