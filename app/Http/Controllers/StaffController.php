...
class StaffController extends Controller
{
    ...
    public function confirmPayment()
    {
        ...
        return view('admin.confirm_payment', ['invoices' => $invoices]);
    }
    ...
    public function confirmInvoice($invoice_id)
    {
        ...
        return back()->with('message', 'Invoice confirmed as paid');
    }

    public function applicants()
    {
        $applicants = Applicant::where('status', 'not admiited')->latest()->get();
        return view('admin.applicants', ['applicants'=> $applicants]);
    }

    public function applicant($applicant_id)
    {
        $arms = Arm::all();
        $sections = Section::all();
        $forms = Form::all();
        $applicant = Applicant::where('id', $applicant_id)->first();
        return view('admin.applicant', ['applicant' => $applicant, 'sections' => $sections, 'forms' => $forms, 'arms' => $arms]);
    }

    public function admitApplicant($applicant_id, Request $request)
    {
        $request->validate([
            'section_id' => 'required',
            'form_id' => 'required',
        ...
        $data = $request->only('section_id', 'form_id', 'arm_id');
        $data['status'] = 'admitted';
        Applicant::where('id', $applicant_id)->update($data);
        return back()->with('message','Applicant Admitted');
    }

    public function announcements()
    {
        $annoucements = Announcement::all();
        return view('admin.announcements', ['announcements' => $annoucements]);
    }
    ...
    public function saveAnnouncement(Request $request)
    {
        ...
        Announcement::reguard();
        return back()->with('message','Announcement added');
    }
